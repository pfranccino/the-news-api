...
export class NewsService {
    ...
    async createNews(newsData : CreateNewsRequest) : Promise<NewsArticleWithId>{
        ...
        const result = await this.db.collection(this.collection).insertOne(newsArticle)
    ...
    async getAllNews(filters: NewsFilters = {}): Promise<{ news: NewsArticleWithId[], total: number }> {
